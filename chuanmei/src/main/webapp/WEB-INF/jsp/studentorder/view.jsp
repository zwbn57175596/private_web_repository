														...
														<tbody>
															<tr>
																<td>当前位置： <span class="fontstyle6522">首页</span>&nbsp;<img
																	...
																	class="fontstyle6522">学生借用查看</span></td>
															</tr>
														</tbody>
										...
										<tbody>
											<tr>
												<td class="list_content">
													...
													value="${teacherOrders.id}">
													<table class="table_border"
														width="100%">
														<tbody>
															<tr>
																<td align="center"><b>申请学生ID：</b>
																</td>
																<td align="center">${studentOrders.userId }_${studentOrders.name}</td>
															</tr>
															<tr>
																<td align="center"><b>开始时间：</b>
																</td>
																<td align="center"><fmt:formatDate value="${studentOrders.sDate}"
																		pattern="yyyy-MM-dd HH:mm:ss" /></td>
															</tr>
															<tr>
																<td align="center"><b>结束时间：</b>
																</td>
																<td align="center"><fmt:formatDate value="${studentOrders.eDate}"
																		pattern="yyyy-MM-dd HH:mm:ss" /></td>
															</tr>
															<tr>
																<td align="center"><b>备注：</b>
																</td>
																<td align="center">${studentOrders.remark }</td>
															</tr>
															<tr>
