														...
														<tbody>
															<tr>
																<td>当前位置： <span class="fontstyle6522">首页</span>&nbsp;<img
																	...
																	class="fontstyle6522">学生借用</span></td>
															</tr>
														</tbody>
													</table> <!--#endeditable-->
												</td>
										...
										<tbody>
											<tr>
												<td class="list_content">
													...
													<br/><br/>
													<form action="/studentOrders/doIn" method="post">
														<input type="hidden" name="id" value="${teacherOrders.id}">
														<input type="hidden" name="sid" value="${studentOrders.id}">
															...
															<tbody>
																...
																<tr>
																	...
																	<td><input name="eTime" class="Wdate" readonly
																		style="width: 160px" type="text" value="${studentOrders.eDate}"  
																		onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})">
																	</td>
																</tr>
																<tr>
																	...
																	<td><textarea name="remark"
																			rows="3" cols="80">${studentOrders.remark}</textarea></td>
																</tr>
																<tr>
																	<td colspan="2" align="center"><input
																		type="submit" value="申请"></td>
																</tr>
															</tbody>
														</table>
													</form>
