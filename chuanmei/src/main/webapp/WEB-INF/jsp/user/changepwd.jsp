...
<body>
	<div class="manage-container">
		...
		<div class="manage_right">
			<div class="manage_breadcrumb">当前位置：首页 > 密码修改</div>
			<form action="/user/changedpwd" method="post">
				<table class="table_border" width="500">
					<tbody>
						<tr>
							<td>ID</td>
							<td><input type="text" readonly name="code"
								value="${user.code}"></td>
						</tr>
						<tr>
							<td>新密码</td>
