...
<script type="text/javascript">
	function goTeacherCheckPage(page) {
		location.href = "/teacherOrdersCheck/list?pageNo=" + page;
	}
</script>
</head>
<body>
														...
														<tbody>
															<tr>
																<td>当前位置：<span class="fontstyle6522">首页</span>&nbsp;<img
																	...
																	class="fontstyle6522">审核老师借用列表</span>
																</td>
															</tr>
														</tbody>
													</table> <!--#endeditable-->
											...
											<tr>
												<td class="list_content">
														...
														<tbody>
															...
															<c:forEach items="${list}" var="row">
																<tr>
																	...
																	<td align="center" title="${row.subject}">${fn:substring(row.subject,0,
																		15)}</td>
																	...
																	<td align="center"><a
																		href="/teacherOrdersCheck/show/${row.id}">查看</a> <a
																		href="/teacherOrdersCheck/incheck?id=${row.id}">审核</a>
																	</td>
																</tr>
															</c:forEach>
														</tbody>
													...
													<div class="list-page">
														...
														<!-- 前一页  -->
														<c:if test="${pageNo>1}">
															<a href="javascript:goTeacherCheckPage(${pageNo-1})">前一页</a>
														</c:if>
														<c:if test="${pageNo<=1}">
														...
														<c:if test="${pageNo<totalPageNo}">
															<a href="javascript:goTeacherCheckPage(${pageNo+1})">后一页</a>
														</c:if>
														<c:if test="${pageNo>=totalPageNo}">
