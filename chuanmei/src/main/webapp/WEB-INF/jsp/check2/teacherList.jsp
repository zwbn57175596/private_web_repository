...
<script type="text/javascript">
	function goTeacherCheckPage(page) {
		location.href = "/teacherOrdersCheck2/list?pageNo=" + page;
	}
</script>
</head>
<body>
	<div class="manage-container">
		...
		<div class="manage_right">
			<div class="manage_breadcrumb">当前位置：首页 &gt; 审核老师借用列表</div>
					...
					<tbody>
						...
						<c:forEach items="${list}" var="row">
							<tr>
								...
								<td align="center"><a
									href="/teacherOrdersCheck2/show/${row.id}">查看</a> <a
									href="/teacherOrdersCheck2/incheck?id=${row.id}">审核</a></td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
